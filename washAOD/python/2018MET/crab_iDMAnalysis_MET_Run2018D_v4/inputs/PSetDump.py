...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('102X_dataRun2_Prompt_v15'),
...
process.p = cms.Path(process.metFilters+process.egmGsfElectronIDSequence+process.egmPhotonIDSequence+process.ak4PFCHSL1FastL2L3ResidualCorrectorChain+process.correctionTermsPfMetType1Type2+process.correctionTermsPfMetType0RecoTrack+process.correctionTermsPfMetMult+process.pfMetT0rtT1Txy+process.ntuples_gbm+process.ntuples_dgm)
