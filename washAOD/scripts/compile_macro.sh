...
g++ -std=c++17 -O3 -m64 TSelectors/mainAnalysisSelectorData_C.so TSelectors/mainAnalysisSelectorMC_C.so $1.o -L$ROOTSYS/lib -lCore -lCling -lRIO -lNet -lHist -lGraf \
-lGraf3d -lGpad -lTree -lRint -lPostscript -lMatrix -lPhysics -lMathCore \
-lThread -pthread -lm -ldl -rdynamic  -o ./bin/$1
