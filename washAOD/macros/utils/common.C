...
namespace common {
    ...
    std::map<int, std::string> cut_descriptions {
        ...
        {5, "nJets > 0 (pT > 30 GeV)"},
        {6, "jets |#eta| < 2.5"},
        {7, "Leading jet pT > 120 GeV"},
        {8, "|#Delta#Phi(jet, MET)| > 0.5"},
        //{7, "|Leading jet #eta| < 3"},
        {9, "nJets < 3 (pT > 30 GeV)"},
        {10, "0 b-tagged jets"},
        {11, "2 dSA muons"},
        {12, "muon 1: >= 2 muon planes"},
        {13, "muon 1: >= 12 muon hits"},
        {14, "muon 1: #chi2 < 10"},
        {15, "muon 1: pT > 5 GeV"},
        {16, "muon 1: |eta| < 2.4"},
        {17, "muon 2: >= 2 muon planes"},
        {18, "muon 2: >= 12 muon hits"},
        {19, "muon 2: #chi2 < 10"},
        {20, "muon 2: pT > 5 GeV"},
        {21, "muon 2: |eta| < 2.4"},
        {22, "muon dR < 0.9"},
    ...
    std::vector<TString> listFiles(const char *dirname, const char *ext) {
