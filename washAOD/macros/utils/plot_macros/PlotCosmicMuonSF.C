...
void PlotCosmicMuonSF(int year=2016, bool fSave=0) {
    ...
    if (year == 2016) {
        ...
        //_file0 = TFile::Open("../../bin/PlotsCosmicsStudiesJune11TighterID/plots_Cosmics_twelthrun_efficiency_pt10_dzlt200_data_2016.root");
        //_file1 = TFile::Open("../../bin/PlotsCosmicsStudiesJune11TighterID/plots_Cosmics_twelthrun_efficiency_pt10_dzlt200_MC_2016.root");
        _file0 = TFile::Open("../../bin/PlotsCosmicsStudiesJune17/plots_Cosmics_twelthrun_efficiency_pt10_dzlt200_data_2016.root");
        _file1 = TFile::Open("../../bin/PlotsCosmicsStudiesJune17/plots_Cosmics_twelthrun_efficiency_pt10_dzlt200_MC_2016.root");
    }
    else if (year == 2017) {
    ...
    obs1_num->Rebin2D(12, 4);
    TH2D * obs1_denom = (TH2D*)hs1_denom->GetStack()->Last();
    obs1_denom->Rebin2D(12, 4);
    ...
    TH2F * hist1 = (TH2F*)obs1_eff->CreateHistogram();
    TH2F * hist0 = (TH2F*)obs0_eff->CreateHistogram();

    TH2F * sf = (TH2F*)hist0->Clone();
    sf->Divide(hist1);

    //TEfficiency * sf = new TEfficiency(*(TH2D*)obs0_eff->CreateHistogram(), *(TH2D*)obs1_eff->CreateHistogram());
    ...
    auto * frame0 = c0->DrawFrame(0, -1.2, 100, 1.2, ";Lower leg (tag) pT [GeV];Lower leg (tag) eta;Scale factor");
    ...
    sf->Draw("COLZ TEXT SAME");
    sf->GetZaxis()->SetTitle("Scale factor");
