...
from iDMAnalysis.skimmer.TrigRecoEffi_cfi import TrigRecoEffi
...
process.RECO_gbm = TrigRecoEffi.clone(trigPath = cms.string('HLT_PFMET120_PFMHT120_IDTight'), muTrack = cms.InputTag("globalMuons"))
