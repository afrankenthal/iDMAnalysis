...
void puwgt(){
TFile *f=new TFile("../macros/bin/PileupZjets/PUdata.root");
...
TFile *g1=new TFile("../macros/bin/PileupZjets/PUZjets100.root");
...
TFile *g2=new TFile("../macros/bin/PileupZjets/PUZjets200.root");
...
TFile *g3=new TFile("../macros/bin/PileupZjets/PUZjets600.root");
...
TFile *g4=new TFile("../macros/bin/PileupZjets/PUZjets800.root");
...
TFile *g5=new TFile("../macros/bin/PileupZjets/PUZjets1200.root");
...
TFile *g6=new TFile("../macros/bin/PileupZjets/PUZjets2500.root");
